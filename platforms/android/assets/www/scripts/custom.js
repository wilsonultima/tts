$(document).ready(function () {      
    ...
    $('.open-submenu').click(function(){
        $(this).parent().find('.submenu').addClass('allow-scroll');
        $(this).parent().find($('.submenu-item').get()).each(function(i){
            var row = $(this)
            setTimeout(function() {
                row.addClass('active-tile delay-it');
            }, 30*i);
        });
        $($('.left-menu .menu-item').get()).each(function(i){
            var row = $(this);
            setTimeout(function() {
                row.removeClass('active-tile');
            }, 30*i);
        });        
        $($('.right-menu .menu-item').get()).each(function(i){
            var row = $(this);
            setTimeout(function() {
                row.removeClass('active-tile');
            }, 30*i);
    ...
    $('.open-left-menu').click(function(){
        $(this).hide(0);
        $('.close-left-menu').show(0);
        $('.left-menu, .menu-tap-close').addClass('allow-scroll');
        $('.menu-tap-close').addClass('shown');
        if($('.left-menu').find('.submenu-scroll').hasClass('active-submenu')){
            $('.active-submenu').addClass('allow-scroll');
            $($('.left-menu .active-submenu a').get()).each(function(i){
                var row = $(this);
                setTimeout(function() {
                    row.addClass('active-tile');
                }, 30*i);
            });
        } else {
            $($('.left-menu .menu-item').get()).each(function(i){
    ...
    $('.left-menu .close-submenu').click(function(){
        $('.submenu').removeClass('allow-scroll');
        $('.right-menu, .menu-tap-close, .left-menu').addClass('allow-scroll');
         $(this).parent().find($('.submenu a').get()).each(function(i){
            var row = $(this);
            setTimeout(function() {
                row.removeClass('active-tile delay-it'); // delay it
            }, 30*i);
        });
        setTimeout(function(){
            $($('.left-menu .menu-item').get()).each(function(i){
    ...
    $('.open-right-menu').click(function(){
        $(this).hide(0);
        $('.close-right-menu').show(0);
        $('.right-menu, .menu-tap-close').addClass('allow-scroll');
        $('.menu-tap-close').addClass('shown');
        if($('.right-menu').find('.submenu-scroll').hasClass('active-submenu')){
            $('.active-submenu').addClass('allow-scroll');
            $($('.right-menu .active-submenu a').get()).each(function(i){
                var row = $(this);
                setTimeout(function() {
                    row.addClass('active-tile');
                }, 30*i);
    ...
    $('.right-menu .close-submenu').click(function(){
        $('.submenu').removeClass('allow-scroll');
        $('.right-menu, .menu-tap-close, .left-menu').addClass('allow-scroll');
         $(this).parent().find($('.submenu a').get()).each(function(i){
            var row = $(this);
    ...
    $('.menu-tap-close, .close-menu, .close-right-menu, .close-left-menu').click(function(){
        $('.close-left-menu, .close-right-menu').hide(0);
        $('.open-left-menu, .open-right-menu').show(0);
        ...
        $($('.active-submenu a').get()).each(function(i){
            var row = $(this);
            setTimeout(function() {
                row.removeClass('active-tile delay-it'); // delay it
            }, 30*i);
        });        
        $($('.delay-it').get()).each(function(i){
            var row = $(this);
            setTimeout(function() {
                row.removeClass('active-tile delay-it'); // delay it
            }, 30*i);
    ...
    if($('body').hasClass('has-cover')){
        ...
        function calculate_covers(){
            ...
            $('.cover-screen').css('height', cover_height - 60);
